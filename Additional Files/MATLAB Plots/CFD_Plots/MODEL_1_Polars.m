...
subplot(122);
plot(AoA_interp_prop, Cl_interp_prop./Cd_interp_prop, 'Color', '#1276b8', 'Linewidth', 2); 
hold on; 
plot(AoA_interp_base, Cl_interp_base./Cd_interp_base, 'Color', 'black', 'LineWidth', 2);
ylabel('C_L / C_D'); 
xlabel('\alpha');
title('{C_L / C_D} comparison between Model 1 and Airfoil')
legend('Model 1', 'base airfoil');
ylim([0 100])
grid minor;
hold off;